...
<Gallery aspectRatio="16 / 9">
  <Image
    src="/images/posts/kitchen-sink/detroit-skyline.jpg"
    alt="Detroit skyline"
    css={{ borderRadius: "0" }}
  />
  <Image
    src="/images/posts/kitchen-sink/drone-snow.jpg"
    alt="Snowy river shot from above via drone"
    css={{ borderRadius: "0" }}
  />
  <Image
    src="/images/posts/kitchen-sink/sleeping-bear.jpg"
