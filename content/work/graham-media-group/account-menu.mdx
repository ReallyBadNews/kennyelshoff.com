...
For Graham Media Group's design system we chose to use Headlelss UI's [Menu (Dropdown)](https://headlessui.dev/react/menu/) for it's simple and compostable API.
...
In the component library we compose the `Menu` and `Menu.Items` components to create a dropdown menu with some basic themeing included.
