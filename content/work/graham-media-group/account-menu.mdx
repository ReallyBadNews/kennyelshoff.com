...
For Graham Media Group's design system we chose to use Headlelss UI's [Menu (Dropdown)](https://headlessui.dev/react/menu/) for it's simple and compostable API. While this package is written and maintained by the Tailwind CSS team, it is not dependant on Tailwind for styling.
